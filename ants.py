...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 11
                if self.ant.container == False and insect.container == True:
                	insect.contain_ant(self.ant)
                	self.ant = insect
                elif self.ant.container == True and insect.container == False and self.ant.can_contain(insect):
    ...
    def remove_insect(self, insect):
        ...
        """
        if insect.is_ant and (not isinstance(insect,QueenAnt) or insect.imposter == True):
        ...
        if not isinstance(insect, QueenAnt) or insect.imposter == True:
            insect.place = None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive, index = 0):
        ...
        """
        # BEGIN Problem 5
        if self.place.bees and (self.min_range == None or self.min_range <= index):
        	return random_or_none(self.place.bees)
        elif self.place.entrance == hive or self.max_range != None and (index >= self.max_range):
        	return None
        else:
        	index += 1
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        ...
        if not Ant.Queenexists:
            self.imposter = False
            Ant.Queenexists = True
        else:
            self.imposter = True
        # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.imposter:
            ...
            while x != None:
                if x.ant:
                    if x.ant.container and x.ant.ant:
                        if x.ant.ant.doubled == False:
                            x.ant.ant.damage *= 2
                            x.ant.ant.doubled = True
                    if x.ant.doubled == False:
